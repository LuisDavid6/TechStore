  ...
  return (
    <div>
      ...
      <div className='bg-global mx-0 my-2 p-4 pt-5 rounded-0 text-start' style={{ minHeight: '69vh' }}>
        ...
        <span className='mb-0 w-25 text-secondary h1'>{currentUser.userName}</span>
        <br />
        <br />
        <br />
        <i className='bi bi-envelope text-white h1 me-3' style={{ fontSize: '44px' }}></i>
        <span className='mb-0 w-25 text-secondary h2'>{currentUser.email}</span>
        <br />
        <br />
        <br />
        <i className='bi bi-card-checklist h1 text-white me-3'></i>
        <span
          className='dropdown-toggle mb-0 w-25 text-white h3'
          ...
          {currentUser.sales && (
            <div className='card card-body mb-3 bg-global text-white border-0 shopping-history'>
              {currentUser.sales.length > 0 ? (
                    ...
                    <div className='card bg-global my-3 border border-1'>
                      <div className='card-body text-white'>
                        ...
                        <p className='card-text text-start'>
                          Estado:{' '}
                          <span className={e.status === 'Pendiente' ? 'text-warning' : e.status === 'Enviado' ? 'text-info' : 'text-success'}>
                            {e.status}
                          </span>
                        </p>

                        <button className='btn btn-primary w-100' data-bs-toggle='modal' data-bs-target={'#d' + e.id.slice(0, 3)}>
                          Detalles
                        </button>
                                    ...
                                    return (
                                      <div>
                                        <div className='row mx-0'>
                                          <div className='col-4'>
                                            <img src={f.image} alt='producto' width='100' height='100'></img>
                                          </div>
                ...
                <div className='bg-global text-white border-0 h6 mt-4 ms-4'>No has realizado ninguna compra</div>
              )}
            </div>
          )}
        </div>
        ...
        <span
          className='dropdown-toggle my-5 w-25 text-white h3'
          data-bs-toggle='collapse'
        ...
        <div className='collapse' id='collapseDesc'>
          <div className='card card-body bg-global text-white border-0 h6 mt-4 ms-4'>No has hecho comentarios aún</div>
        </div>
      </div>
      <Footer />
    </div>
