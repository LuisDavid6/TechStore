                  ...
                  <div className='card-body row'>
                    ...
                    <div className='col-1 my-auto'>
                      <i
                        ...
                        data-bs-target={'#m' + e.id.slice(0, 3)}
                      ></i>
                      <div
                    ...
                    <div className='col-1 my-auto'>
                      <i
                        ...
                        title='Eliminar'
                        data-bs-toggle='modal'
                        data-bs-target={'#p' + e.id.slice(0, 3)}
                      ></i>
                    </div>
                      ...
                      <div className='modal-dialog'>
                        <div className='modal-content bg-global'>
                          ...
                          <div className='modal-footer'>
                            ...
                            <button type='button' className='btn btn-primary' data-bs-dismiss='modal' onClick={() => dispatch(deleteProduct(e.id))}>
                              Confirmar
                            </button>
                          </div>
                        </div>
              ...
              pages.map((e) => {
                return (
                  <button
                    ...
                    onClick={() => {
                      filter ? dispatch(filterCategoryByPage(e, filter)) : dispatch(getProductsByPage(e))
                      setPage(e)
                    }}
                  >
                    {e}
