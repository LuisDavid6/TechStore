    ...
    <div className='row mx-2 mt-2 gap-2'>
      <div className='col-sm-4 card text-center bg-global mx-auto my-2'>
        ...
        <div className='card-body d-flex justify-content-center'>
          <input type={"date"} value={date} className="form-control me-2" onChange={e=> handleOnDate(e.target.value)} style={{maxWidth:"130px"}}></input>
          <input type={"month"} value={month} className="form-control" onChange={e=> handleOnMonth(e.target.value)} style={{maxWidth:"185px"}}></input>
