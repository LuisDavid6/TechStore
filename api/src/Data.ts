...
//     discount: 10,
//     type: "PS4",
//     description:"Juago de accion",
//     specs:[{"tam":10}, {"procesador":"intel"}],
//     stock: 1,
...
const MotoG22 = {
    ...
    specs:[
            ...
            {"Bateria":"5000 mAh"},
            {"Tipo de cargador":"Carga TurboPower ™"},
            {"Sensores":"Acelerómetro, Proximidad, Huella digital"},
            {"Cámara Trasera":"50MP +8MP (ultrawide) + 2MP (macro) + 2MP (depth)"},
            {"Cámara Frontal":"16 MP"},
            {"Bluetooth":"Bluetooth 5"},
            {"Bandas":"2G/3G/4G VoLTE"},
            {"Servicios de localización":"GPS, AGPS, GLONASS"},
