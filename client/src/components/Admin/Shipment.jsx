                                ...
                                return (
                                  <div key={f.id}>
                                    <div className='row mx-0'>
                                      ...
                                      <div className='col-4'>
                                        <img src={f.image} width='100' height='100' alt={f.name}></img>
                                      </div>
                            ...
                            <div className='text-center fw-bold h5'>
                              {e.status === 'Entregado' ? (
                                ...
                                <button
                                  ...
                                  onClick={() => changeStatus(e.id, e.status, e.user.id)}
                                >
                                  {e.status === 'Pendiente' ? 'Confirmar envio' : 'Confirmar entrega'}
                                </button>
                              )}
                            </div>
                          </div>
