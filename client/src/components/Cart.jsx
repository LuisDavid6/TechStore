      ...
      {currentUser.cart && currentUser.cart.products.length > 0 ? (
        <div>
              ...
              <div className='card bg-global my-2 w-75 mx-auto' key={e.name}>
                <div className='card-body row'>
                  ...
                  <div className='col my-auto mx-auto text-center'>
                    <i
                      className='bi bi-dash-circle h5 text-white cursor'
                      title='remover'
                      onClick={() => dispatch(removeFromCart({ userId: currentUser.id, productId: e.id }))}
                    ></i>
                    <span className='text-white mx-2 fw-bold h5'>{e.cant}</span>
                    <i
                      className='bi bi-plus-circle h5 text-white cursor'
                      title='agregar'
                      onClick={() => dispatch(addToCart({ userId: currentUser.id, productId: e.id }))}
                    ></i>
                  </div>
                  <div className='col my-auto ps-5'>
          ...
          <div className='container bg-global container-fix rounded-3 p-3 my-5'>
            ...
            <button type='button' className='btn btn-secondary btn-lg px-5 my-4' data-bs-toggle='modal' data-bs-target='#exampleModalToggle'>
              Ir a pagar
            </button>
          </div>
            ...
            <div className='modal-dialog modal-dialog-centered'>
              <div className='modal-content bg-dark'>
                <div className='modal-header'>
                  <h5 className='modal-title text-white' id='exampleModalToggleLabel'>
                    Realizar Pago
                  </h5>
                ...
                <div className='modal-body'>
                  <div className='text-end text-white'>
                    <i
                      className='bi bi-info-circle-fill text-warning h3 me-4 cursor'
                    ...
                    <div className='collapse' id='collapseInfo'>
                      <div className='card card-body bg-global border-0 h6 fst-italic fw-normal text-center'>
                        Puedes usar la tarjeta de prueba: <br />
                        <br />
                  ...
                  <div className='text-white p-4'>
                    <form onSubmit={handleSubmit}>
                      ...
                      <button
                        ...
                        type='submit'
                        data-bs-toggle={correctCard ? 'modal' : null}
                        data-bs-target={correctCard ? '#staticBackdrop' : null}
                      >
                        Pagar
                      </button>
                    </form>
              ...
              <div className='modal-content bg-dark'>
                {loading ? (
                  ...
                  <div className='modal-body text-white h3'>
                    ...
                    <button className='btn btn-outline-info mt-3' data-bs-toggle='modal' data-bs-target='#exampleModalToggle'>
                      Intentar nuevamente
                    </button>
                  </div>
                ) : (
                  <div className='modal-body text-white h3'>
                    ...
                    <Link to='/home'>
                      <button className='btn btn-outline-info mt-3 me-3' data-bs-dismiss='modal' aria-label='Close'>
                        Volver a inicio
                      </button>
                    </Link>
                    <Link to='/profile'>
                      <button className='btn btn-outline-info mt-3' data-bs-dismiss='modal' aria-label='Close'>
                        Ir a mis compras
                      </button>
                    </Link>
                  </div>
