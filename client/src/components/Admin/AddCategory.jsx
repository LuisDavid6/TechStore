...
export default function AddCategory() {
  ...
  return (
    <div>
      <button className='btn btn-sm btn-outline-secondary text-white p-2 m-1' data-bs-toggle='modal' data-bs-target='#CategoryModal'>
        Agregar Categoria
      </button>
      <button className='btn btn-sm btn-outline-secondary text-white p-2 m-1' data-bs-toggle='modal' data-bs-target='#SubcategoryModal'>
              ...
              <div className='modal-body text-start'>
                ...
                >
                  ...
                  {categories &&
                    categories.map((e) => {
                      return (
                        <option value={e.id} className='outline-secondary' key={e.name}>
                          {e.name}
                        </option>
                      )
                    })}
