      ...
      <div className='row mx-0'>
                ...
                categories.map((e) => {
                  return (
                    <>
                      ...
                      <label className='btn btn-outline-secondary text-white rounded-2' for={e.name} onClick={() => handleCategory(e.name)}>
                        {e.name}
                      </label>
                    </>
                  )
        ...
        <div className='col'>
          <div className='mx-auto pt-3 pb-5 text-end d-flex justify-content-end pe-1'>
            ...
            <button className='btn btn-outline-secondary text-white py-2' data-bs-toggle='modal' data-bs-target='#newProductModal'>
              Agregar Producto
            </button>
            <div
