      ...
      <div className='mt-4'>
        {productsFilter[0] === 'notFound' ? (
          <div className='text-white mt-5 h2'>
            ...
            <img src='/assets/NoResults.gif' alt='no results'></img>
          </div>
              ...
              return (
                <div key={e.id} className='card rounded bg-global'>
                  <div className='card-body p-0 h-100'>
                    <img src={e.image} className='rounded' alt={e.name} width='100%' height='100%' />
                  </div>
                  <div className='card-body'>
                    <h6 className='card-title text-white text-wrap lh-base text-truncate' style={{ height: '50px' }}>
                      {e.name}
                    </h6>
                  </div>
                  <div className='card-body'>
                    ...
                    {e.discount > 0 ? (
                      <div className='my-1'>
                        ...
                        <p className='text-white h5 fw-bold'>
                          {convertPrice(e.totalPrice)} <span className='text-warning h5'>Hoy</span>
                        </p>
                      </div>
                    ) : (
                      <div className='my-1'>
